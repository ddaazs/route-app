...
<body>
    <div>
        <form class="mx-auto mt-3 form-control" action="{{ route('cars.store') }}" method="post">
         ...
         <div class="mt-2 input-group-text">
            <label for="created_year">Photo:</label>
            <input class="border ms-5" type="file" id="created_year" name="created_year">
        </div>
